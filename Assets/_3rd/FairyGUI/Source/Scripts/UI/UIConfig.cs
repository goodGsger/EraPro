...
namespace FairyGUI
{
	...
	public class UIConfig : MonoBehaviour
	{
        ...
        // FairyGUI修改：延迟创建对象数量
        public static int createObjectAsyncCount = 50;
        ...
        /// 默认按钮声音ID
        /// </summary>
        public static int defaultButtonSoundID = 0;

        /// <summary>
        /// 默认声音音量
        /// </summary>
        public static float defaultButtonSoundVolume = 1f;
        ...
        /// 按钮播放声音代理
        /// </summary>
        public static ButtonPlaySoundDelegate playSoundFunc;
